...
<!-- ----------------------------------------------HEADER-------------------------------------------------- -->            
            <header>
                <a href="landing.html" class="logo-header">UKM Bahagia</a>
                ...
                <div class="nav-and-reg">
                    ...
                    <button class="btn-signin" onclick="location.href='login.php'">Masuk</button>
                </div>
            </header>
<!-- ----------------------------------------------CONTENT------------------------------------------------- -->
            <div class="log-reg log">
                <div class="tab-menu">
                    <a href="login.php" class="tab-menu-active">Masuk</a>
                    <a href="registration.html">Daftar</a>
                </div>                
